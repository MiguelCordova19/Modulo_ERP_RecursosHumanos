-- =====================================================
-- PROCEDIMIENTO PARA ACTUALIZAR TRABAJADOR DESDE CONTRATO
-- =====================================================

-- Crear función para actualizar trabajador con datos del contrato
...
COMMENT ON FUNCTION public.sp_actualizar_trabajador_desde_contrato IS 'Actualiza los datos del trabajador con la información del contrato';

-- Actualizar el procedimiento sp_guardar_contrato_trabajador para que actualice el trabajador
...
COMMENT ON FUNCTION public.sp_guardar_contrato_trabajador IS 'Guarda un contrato y actualiza automáticamente los datos del trabajador';

-- Actualizar el procedimiento sp_actualizar_contrato_trabajador
...
DO $$
BEGIN
    RAISE NOTICE '✅ Procedimiento sp_actualizar_trabajador_desde_contrato creado';
    ...
    RAISE NOTICE '✅ Ahora al guardar/actualizar un contrato, se actualizará automáticamente el trabajador';
END $$;
